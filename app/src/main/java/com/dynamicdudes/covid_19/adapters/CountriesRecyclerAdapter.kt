...
class CountriesRecyclerAdapter(val listOfCountries : all_countries,communication: FragmentCommunication) : RecyclerView.Adapter<CountriesRecyclerAdapter.CountriesviewHolder>(){
    var mCommunication = communication
    class CountriesviewHolder(itemView : View, val communications: FragmentCommunication) : RecyclerView.ViewHolder(itemView){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CountriesviewHolder {
        ...
        return CountriesviewHolder(view,mCommunication)
    }
